/*
    Taken from: https://github.com/ronak197/Parallel-K-means-Clustering/blob/master/k-means_parallel.c
    gcc -g -Wall -o k-means-parallel k-means-parallel.c -lm -fopenmp
*/
